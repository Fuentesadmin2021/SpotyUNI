...
cancion = [
    (1, 'Ordinary People', 'adele', 'blues', 'primero', "canciones/ordinary_people.mp3"),
    (2, 'Someone Like You', 'Adele', 'blues', 'segundo', "canciones/drink_wine.mp3"),
    (3, 'Never Gonna Give You Up', 'Ray charles', 'blues', 'tercero', "canciones/never_gonna_give_you_up.mp3"),
    (4, 'Zumba que Zumba', 'Llano', 'Llanero', 'cuarto', "canciones/zumba_que_zumba.mp3"),
    (5, 'Hit the Road Jack', 'Ray Charles', 'Blues', 'quinto', "canciones/hit_the_road_jack.mp3")
]
...
class SpotyUNI(QtWidgets.QMainWindow):
    def __init__(self, lista_informacion):
        ...
        self.ui.table_canciones.setHorizontalHeader(self.ui.table_canciones.horizontalHeader().setFont(QtGui.QFont("Times", 14, QtGui.QFont.Bold)))
        ...
        """self.ui.table_canciones.setColumnWidth(0, 10)
        self.ui.table_canciones.setColumnWidth(1, 400)
        self.ui.table_canciones.setColumnWidth(2, 230)
        self.ui.table_canciones.setColumnWidth(3, 125)
        self.ui.table_canciones.setColumnWidth(4, 151)"""
